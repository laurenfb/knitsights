...
/***/ function(module, exports, __webpack_require__) {
	...
	var _account_view = __webpack_require__(309);
	...
	var ApplicationView = _backbone2.default.View.extend({
	  ...
	  import: function _import(event) {
	    ...
	    var importV = new _import_view2.default({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _spin = __webpack_require__(308);
	...
	var ImportView = _backbone2.default.View.extend({
	  initialize: function initialize() {
	    (0, _jquery2.default)('.btn-import-save').empty();
	    (0, _jquery2.default)('.btn-import-save').append("save");
	  ...
	  putProjectsInClusters: function putProjectsInClusters(cluster, listOfProjects) {
	    for (var i = 0; i < listOfProjects.length; i++) {
	      var project = new _project2.default(listOfProjects[i]);
	      cluster.add(project);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _thumbnail_view = __webpack_require__(310);
