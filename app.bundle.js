...
/******/ 	__webpack_require__.p = "/knitsights";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _application_view = __webpack_require__(299);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _import_view = __webpack_require__(303);

	var _import_view2 = _interopRequireDefault(_import_view);

	var _account_view = __webpack_require__(308);

	var _account_view2 = _interopRequireDefault(_account_view);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var ApplicationView = _backbone2.default.View.extend({
	  initialize: function initialize() {
	    this.topNavT = _underscore2.default.template((0, _jquery2.default)('#top-nav-template').html());
	  },

	  render: function render() {
	    console.log("ApplicationView rendered");
	    // console.log(this.$el::before)
	    (0, _jquery2.default)('body').prepend(this.topNavT);
	  ...
	  import: function _import(event) {
	    ...
	    var importV = new _import_view2.default({ el: (0, _jquery2.default)('main') });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _project = __webpack_require__(304);

	var _project2 = _interopRequireDefault(_project);

	var _cluster = __webpack_require__(305);

	var _cluster2 = _interopRequireDefault(_cluster);

	var _cluster_view = __webpack_require__(306);

	var _cluster_view2 = _interopRequireDefault(_cluster_view);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var clusters = [{ "name": "sweaters", "projects": [{ clusterID: 1,
	    photoURL: "http://placebeyonce.com/250-250",
	    timeInDays: 28,
	    name: "blue sweater" }, { clusterID: 1,
	    photoURL: "http://placebeyonce.com/250-250",
	    timeInDays: 12,
	    name: "husband sweater" }, { clusterID: 1,
	    photoURL: "http://placebeyonce.com/250-250",
	    timeInDays: 100,
	    name: "customfit sweater" }, { clusterID: 1,
	    photoURL: "http://placebeyonce.com/250-250",
	    timeInDays: 29,
	    name: "cat sweater" }] }, { "name": "socks", "projects": [{ clusterID: 2,
	    photoURL: "http://placebeyonce.com/250-250",
	    timeInDays: 14,
	    name: "ctb socks" }, { clusterID: 2,
	    photoURL: "http://placebeyonce.com/250-250",
	    timeInDays: 12,
	    name: "socks for me" }] }];
	...
	var ImportView = _backbone2.default.View.extend({
	  initialize: function initialize() {
	    (0, _jquery2.default)('.btn-import').hide();
	    (0, _jquery2.default)('.btn-save').show();
	  ...
	  renderClusters: function renderClusters() {
	    clusters.forEach(function (clus) {
	      ...
	      var clusID = clus["projects"][0]["clusterID"];
	      var cluster = new _cluster2.default(null, { name: clus["name"], id: clusID });
	      var clusterView = new _cluster_view2.default({
	        model: cluster
	      });
	      for (var i = 0; i < clus["projects"].length; i++) {
	        var project = new _project2.default(clus["projects"][i]);
	        cluster.add(project);
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cluster = _backbone2.default.Collection.extend({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _project_view = __webpack_require__(307);

	var _project_view2 = _interopRequireDefault(_project_view);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _thumbnail_view = __webpack_require__(309);

	var _thumbnail_view2 = _interopRequireDefault(_thumbnail_view);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var AccountView = _backbone2.default.View.extend({
	  initialize: function initialize(options) {
	  ...
	  renderClusters: function renderClusters() {
	    this.clusters.forEach(function (clus) {
	      var thumbnailV = new _thumbnail_view2.default({ model: clus });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ThumbnailView = _backbone2.default.View.extend({
	  className: "thumbnail",

	  initialize: function initialize() {
	    this.thumbnailT = _underscore2.default.template((0, _jquery2.default)('#thumbnail-template').html());
	  },
